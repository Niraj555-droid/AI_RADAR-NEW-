    ...
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <section className="py-20 bg-black">
        <div className="container mx-auto px-4">
          ...
          {/* Third Row - Three New Features */}
          <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
            {/* Daily Sales & Expense Tracker */}
            <Card
              className="bg-gradient-to-br from-green-900/20 to-black border-green-700 p-8 card-hover cursor-pointer animate-slide-in-right animation-delay-600"
              onClick={() => navigate('/sales-tracker')}
            >
              <Badge className="mb-4 bg-green-600 text-white">💰 Financial Tracker</Badge>
              <h3 className="text-2xl font-bold mb-4 text-white">
                Daily Sales & Expense Tracker
              </h3>
              <p className="text-gray-300 mb-6 text-sm">
                Record daily cash and online payments, track expenses, calculate profit, and identify peak business hours. Maintain financial discipline without advanced accounting skills.
              </p>
              <div className="space-y-2 mb-6">
                <div className="flex items-center gap-2 text-sm text-gray-400">
                  <span>✓</span> Daily profit calculation
                </div>
                <div className="flex items-center gap-2 text-sm text-gray-400">
                  <span>✓</span> Peak hours identification
                </div>
                <div className="flex items-center gap-2 text-sm text-gray-400">
                  <span>✓</span> Cost alerts & insights
                </div>
              </div>
              <Button className="w-full bg-green-600 hover:bg-green-700">
                Open Sales Tracker →
            ...
            {/* Licensing & Government Scheme Assistance */}
            <Card
              className="bg-gradient-to-br from-blue-900/20 to-black border-blue-700 p-8 card-hover cursor-pointer animate-slide-in-right animation-delay-700"
              onClick={() => navigate('/licensing-assistance')}
            >
              <Badge className="mb-4 bg-blue-600 text-white">🛡️ Legal Support</Badge>
              <h3 className="text-2xl font-bold mb-4 text-white">
                Licensing & Scheme Assistance
              </h3>
              <p className="text-gray-300 mb-6 text-sm">
                Step-by-step guidance for FSSAI registration, hawker permits, PM SVANidhi loans, and more. Get document checklists, auto-filled forms, and renewal alerts.
              </p>
              <div className="space-y-2 mb-6">
                <div className="flex items-center gap-2 text-sm text-gray-400">
                  <span>✓</span> FSSAI & Hawker permits
                </div>
                <div className="flex items-center gap-2 text-sm text-gray-400">
                  <span>✓</span> Government schemes
                </div>
                <div className="flex items-center gap-2 text-sm text-gray-400">
                  <span>✓</span> Auto-form filling
                </div>
              </div>
            ...
            {/* Business Boosting & Digital Presence */}
            <Card
              className="bg-gradient-to-br from-pink-900/20 to-black border-pink-700 p-8 card-hover cursor-pointer animate-slide-in-right animation-delay-800"
              onClick={() => navigate('/digital-presence')}
            >
              <Badge className="mb-4 bg-pink-600 text-white">📱 Digital Marketing</Badge>
              <h3 className="text-2xl font-bold mb-4 text-white">
                Digital Presence & Marketing
              </h3>
              <p className="text-gray-300 mb-6 text-sm">
                Get onboarded to Zomato/Swiggy, access video/reel ideas, connect with food vloggers, and generate seasonal promotional content with captions and hashtags.
              </p>
              <div className="space-y-2 mb-6">
                <div className="flex items-center gap-2 text-sm text-gray-400">
                  <span>✓</span> Zomato/Swiggy onboarding
                </div>
                <div className="flex items-center gap-2 text-sm text-gray-400">
                  <span>✓</span> Content ideas & scripts
                </div>
                <div className="flex items-center gap-2 text-sm text-gray-400">
                  <span>✓</span> Vlogger connections
                </div>
              </div>
